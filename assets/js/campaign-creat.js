...
function deleteData(e){
    ...
    var samp = $(e).parent().parent().parent().addClass("dumil");
    $(e).parent().parent().remove();
    
    var dumil = $(".dumil").html();
    console.log(dumil);
    if(dumil === ""){
        console.log("true");
               $(".dumil").append(html)
        $(".dumil").removeClass("dumil");
    }
    else{
        console.log("false");
    }
