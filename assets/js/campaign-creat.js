...
width : 320,
 plugins: [
    'advlist autolink lists link image charmap print hr preview anchor textcolor',
...
function textEdit(e, samp){
    ...
    if (dataContent === "none"){
        ...
        $(".addedEditables").addClass("indiText").removeClass("empty-content").html("<div class=\"textContent\" data-text=\"newEdit\">Enter your content</div>");
    ...
    if(fileName) { // returns true if the string is not empty
       ...
       tabposition("layouts");
        ...
        $(".buttonNowEditing").removeClass("buttonNowEditing");
            $("[data-button]").attr("data-button","edited");
        removeLayoutSettingElementSupport();
        $("#cards").attr("data-content", "none");
        dataEditor("false");
    }
...
function deleteData(e){
    ...
    var samp = $(e).parent().parent().parent().addClass("deleteDataContent");
